...
def dataloader(dataset, batch_size, train, workers, length=None, ddp=False):
    # Dataset
    if dataset == 'mnist':
    ...
    if dataset == 'tiny-imagenet':
        ...
        if train:
            transform = transforms.Compose([
                transforms.RandomResizedCrop(size=64, scale=(0.1, 1.0), ratio=(0.8, 1.25)),
...
def pruner(method):
    prune_methods = {
        ...
        'itersnip': pruners.IterSNIP,
        'NTKSAP': pruners.NTKSAP,
    }
